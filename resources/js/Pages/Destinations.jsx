            ...
            >
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <Link href="/destinations" className="text-[#00a896] font-medium text-sm transition-all duration-300 relative py-1 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px] after:bg-[#00a896] after:transition-all after:duration-300">Destinasi</Link>
            ...
            <main className="py-24 max-w-7xl mx-auto px-6">
                {!selectedDest ? (
                    ...
                    <div className="animate-fade-in">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-12 border-b border-slate-200 pb-5">
                            <div className="flex flex-wrap gap-2.5">
                                <button className="bg-[#1e293b] text-white text-xs font-semibold px-5 py-2.5 rounded-full transition-all">
                                    Popular destination
                                </button>
                                <button className="bg-slate-200/60 hover:bg-slate-200 text-slate-700 text-xs font-semibold px-5 py-2.5 rounded-full transition-all">
                                    Islands
                                </button>
                                <button className="bg-slate-200/60 hover:bg-slate-200 text-slate-700 text-xs font-semibold px-5 py-2.5 rounded-full transition-all">
                                    History
                            ...
                            <button className="flex items-center gap-2 border border-slate-300 hover:bg-slate-100/80 px-4 py-2.5 rounded-xl text-xs font-semibold transition-all w-fit">
                        ...
                        <div className="flex justify-center mt-16">
                            <button className="border border-slate-300 hover:bg-slate-100 text-slate-700 font-semibold px-8 py-3.5 rounded-full text-sm transition-all">
                                Show more
                            </button>
                        </div>
                    </div>
